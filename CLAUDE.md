...
- v3.0.0 底部三栏导航（卜算/解卦/档案）+ 档案管理（CRUD+紫微/八字/称骨全方位卜算）+ AI 解卦（GLM-4-Flash）+ 称骨/太乙入场仪式补全
...
- v3.1.4 解卦 AI 流式输出（SSE 打字机效果）
- 后续可考虑：深化全方位卜算（三术交叉印证/每术更详细/缺时辰降级/可视化融合）、择日黄历（第16术）、仪式动画浅色适配、紫微流年深化、解卦深化（当前卦直发）、档案扩展、v3.x 新术数 / 数据云同步 / 国际化
